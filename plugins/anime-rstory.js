...
let rstory = await getBuffer(dir[Math.floor(Math.random() * dir.length)])

let ptv = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({ ptvMessage: rstory }), { userJid: m.chat, quoted: m })
