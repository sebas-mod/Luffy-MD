            ...
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        let bienvenida_api = await fetch(`https://api-zenith.koyeb.app/api/maker/welcome?name=${this.getName(user)}&gpname=${groupMetadata.subject}&member=${groupMetadata.participants.length}&pp=${pp}&bg=https://telegra.ph/file/fea867e29574ad52c3660.jpg&apikey=zenkey`)
                        let wel = await new knights.Welcome()
                            ...
                            .toAttachment()
                        let salida_api = await fetch(`https://api-zenith.koyeb.app/api/maker/goodbye?name=${this.getName(user)}&gpname=${groupMetadata.subject}&member=${groupMetadata.participants.length}&pp=${pp}&bg=https://telegra.ph/file/fea867e29574ad52c3660.jpg&apikey=zenkey`)
                        ...
                        this.sendFile(id, action === 'add' ? wel.buffer() : lea.buffer(), 'pp.jpg', text, null, false, { contextInfo: { mentionedJid: [user] } })
                    }
                }
            }
            break
